...
/**
 * Hard cap the GENERATOR enforces on a finished post. Premium allows 25,000 on
 * the platform, so this sits just below at 24,000 — long-form is legitimate.
 * The publish layer keeps X_MAX_CHARS (25,000) as the absolute backstop.
 */
 ...
 * the account is X Premium with a 25,000-char platform limit. A 160-char floor
 * was admitting posts the account never wanted to ship. Threads and replies
