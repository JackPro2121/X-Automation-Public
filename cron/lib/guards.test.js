...
const overLong = `${'A concrete engineering insight worth reading. '.repeat(40)}Final line here.`;
...
console.log('✓ guard regression checks passed (placeholder, off-topic, truncation, finalize, fabricated authority, fabricated experience)');
