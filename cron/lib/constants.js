...
/** X (Twitter) character limit per tweet (25,000 for Premium, 280 for Free). */
 ...
 * Owner updated: target reduced to 20-25/day (quality over quantity, OCR strategy).
 */
export const DAILY_TARGET = 16;
