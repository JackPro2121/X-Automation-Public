...
import { isDuplicate, generateId, validateEnv, stripMarkdown, stripMentions, fixStaleModelNames, isLikelyEnglish, isMetaTextCaption, formatPostWhitespace } from './lib/utils.js';
...
async function main() {
  ...
  try {
    ...
    if (!comment || comment.length < 40) {
      console.log('  ⚠ Comment generation failed or too short. Exiting.');
      return;
    }
